...
def dedupe_features_ai(features: list[str]) -> dict:
    ...
    rules = (
        ...
        "license' vs 'Priority generation'. When in doubt, DO NOT merge — map the feature to "
        "ITSELF (its own verbatim name). Over-merging unrelated features is a WORSE error "
        "than leaving near-duplicates separate.\n"
